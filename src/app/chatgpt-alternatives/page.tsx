      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <Link href="/blog/chatgpt-vs-claude" className="bg-gray-900 border border-gray-800 rounded-xl p-5 hover:border-blue-500/40 transition group">
            <h3 className="font-semibold group-hover:text-blue-400 transition mb-2">ChatGPT vs Claude: Full Comparison</h3>
            <p className="text-gray-500 text-sm">Head-to-head breakdown of capabilities, pricing, and best use cases.</p>
          </Link>
          <Link href="/blog/chatgpt-vs-claude-vs-gemini" className="bg-gray-900 border border-gray-800 rounded-xl p-5 hover:border-blue-500/40 transition group">
            ...
            <p className="text-gray-500 text-sm">Three-way comparison of the leading AI assistants for 2026.</p>
          </Link>
