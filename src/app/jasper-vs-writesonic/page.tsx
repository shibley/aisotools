      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-yellow-500/5 border border-yellow-500/20 rounded-xl p-8">
            ...
            <Link href="/tool/jasper" className="inline-block mt-6 bg-yellow-600 hover:bg-yellow-700 text-white px-5 py-2.5 rounded-lg font-medium transition">Try Jasper →</Link>
          </div>
          <div className="bg-blue-500/5 border border-blue-500/20 rounded-xl p-8">
            ...
            <Link href="/tool/writesonic" className="inline-block mt-6 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg font-medium transition">Try Writesonic →</Link>
          </div>
        </div>
      </section>
